...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-17T13:43:20.340Z")

@RestSchema(schemaId = "test")
@RequestMapping(path = "/test002", produces = MediaType.APPLICATION_JSON)
